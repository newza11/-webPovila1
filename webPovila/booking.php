...
// Retrieve the data sent from index.php
$check_in = $_GET['checkin'] ?? 'ไม่ระบุ';
$check_out = $_GET['checkout'] ?? 'ไม่ระบุ';
$room = $_GET['room'] ?? 'ไม่ระบุ';

// Assuming a fixed price per night for simplicity
$price_per_night = 12000; // Example price
    ...
    <div class="container">
        <div class="details">
            <div class="header">
                ...
                <p>Check-in: <?php echo htmlspecialchars($check_in, ENT_QUOTES, 'UTF-8'); ?></p>
                <p>Check-out: <?php echo htmlspecialchars($check_out, ENT_QUOTES, 'UTF-8'); ?></p>
                <p>ห้อง: <?php echo htmlspecialchars($room, ENT_QUOTES, 'UTF-8'); ?></p>
            </div>
            <div class="summary">
                <p>ราคาต่อคืน: THB <?php echo number_format($price_per_night); ?></p>
